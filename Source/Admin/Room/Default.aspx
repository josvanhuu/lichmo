<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Room_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="gvRoom" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false" Width="100%" OnRowCommand="gvRoom_RowCommand" DataKeyNames="ID">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText='Tên phòng' HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="TabelQuantity" HeaderText='Số bàn mổ'  />
    ...
    <asp:Panel ID="pnEdit" runat="server" Visible="false">
        ...
        <tr>
            ...
            <td>Số bàn mổ:  </td>
            <td><asp:TextBox ID="txtTable" runat="server" Width="300px" Text="1"></asp:TextBox></td>            
        </tr>        
        <tr>
            <td colspan="4">
